class AdminController < ApplicationController
  ...
  def getAdminSumNumberMeals
    @routeMeals = ClientInteraction.joins(:client, {location_camp: {location: :route}}).select("routes.name, sum(clients.number_meals) as totalNumberMeals").group("routes.name")
