class HeatersController < ApplicationController
  ...
  private
    ...
    def heater_params
      params.require(:heater).permit(:heater_type_id, :serial_number, :heater_status_id, :is_active, :updated_at)
    end
end
