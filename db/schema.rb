...
ActiveRecord::Schema.define(version: 2026_04_21_023010) do
  ...
  create_table "client_barriers", force: :cascade do |t|
    t.integer "client_id"
  ...
  create_table "client_caseworkers", force: :cascade do |t|
  ...
  create_table "client_circle_of_friends", force: :cascade do |t|
