...
{route_id: 1, name: 'Second Stop', position: 2, notes: 'This is another test', latitude: 8743.32, longitude: 9283.38, is_active: true},
{route_id: 1, name: 'Third Stop', position: 3, notes: 'This is text', latitude: 8743.32, longitude: 9283.38, is_active: true},
{route_id: 1, name: 'Fourth Stop', position: 4, notes: 'Sample text', latitude: 8743.32, longitude: 9283.38, is_active: true},
{route_id: 2, name: 'Number 1 Stop', position: 1, notes: 'Vague text', latitude: 8743.32, longitude: 9283.38, is_active: true},
{route_id: 2, name: 'Number 2 Stop', position: 2, notes: 'This is a location', latitude: 8743.32, longitude: 9283.38, is_active: true},
{route_id: 2, name: 'The 3rd Stop', position: 3, notes: 'This is another location', latitude: 8743.32, longitude: 9283.38, is_active: true},
{route_id: 2, name: 'The 4th Stop', position: 4, notes: 'This is a description of notes', latitude: 8743.32, longitude: 9283.38, is_active: true},
{route_id: 3, name: '1st Stop', position: 1, notes: 'Some more text', latitude: 8743.32, longitude: 9283.38, is_active: true},
{route_id: 3, name: '2nd Stop', position: 2, notes: 'I am still going here', latitude: 8743.32, longitude: 9283.38, is_active: true},
{route_id: 3, name: 'The Third Stop', position: 3, notes: 'There is a lot of seed data', latitude: 8743.32, longitude: 9283.38, is_active: true},
{route_id: 3, name: 'The Fourth Stop', position: 4, notes: 'Some more seed data', latitude: 8743.32, longitude: 9283.38, is_active: true},
{route_id: 4, name: 'First Stop', position: 1, notes: 'And some more', latitude: 8743.32, longitude: 9283.38, is_active: true},
{route_id: 4, name: '2nd Stop', position: 2, notes: 'Someday I will be done', latitude: 8743.32, longitude: 9283.38, is_active: true},
{route_id: 4, name: '3rd Stop', position: 3, notes: 'Might be half way done', latitude: 8743.32, longitude: 9283.38, is_active: true},
{route_id: 4, name: '4th Stop', position: 4, notes: 'Definitely halfway done now', latitude: 8743.32, longitude: 9283.38, is_active: true},
{route_id: 4, name: '5th Stop', position: 5, notes: 'I am listening to mt joyj', latitude: 8743.32, longitude: 9283.38, is_active: true},
{route_id: 4, name: '6th Stop', position: 6, notes: 'The music is really good', latitude: 8743.32, longitude: 9283.38, is_active: true},
{route_id: 5, name: 'First Stop', position: 1, notes: 'Four left to write', latitude: 8743.32, longitude: 9283.38, is_active: true},
{route_id: 5, name: 'Second Stop', position: 2, notes: 'I am very close now', latitude: 8743.32, longitude: 9283.38, is_active: true},
{route_id: 5, name: 'Third Stop', position: 3, notes: 'Almost there', latitude: 8743.32, longitude: 9283.38, is_active: true},
{route_id: 6, name: 'Eins Stop', position: 1, notes: 'This is some more notes on a location', latitude: 8743.32, longitude: 9283.38, is_active: true},
{route_id: 7, name: 'Uno Stop', position: 1, notes: 'This is the last one', latitude: 8743.32, longitude: 9283.38, is_active: true}]
...
clients = [{preferred_name: 'Kevin Lewis', is_veteran: false, is_aftercare: false, birth_date: '07/10/1993', shoe_size: '9', phone: '6417999450', joppa_apartment_number: '', number_meals: 2},
...
{preferred_name: 'Ryan Rutherford', is_veteran: false, is_aftercare: false, birth_date: '09/18/1990', shoe_size: '10', phone: '2983981711', joppa_apartment_number: '', number_meals: 0},
